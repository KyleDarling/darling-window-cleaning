...
function Button({ children, className = "", variant = "default", ...props }) {
  const base = "inline-flex items-center justify-center font-medium transition cursor-pointer";
  const variants = {
    default: "bg-sky-600 text-white hover:bg-sky-700 border border-transparent",
...
function Input({ className = "", ...props }) {
  return <input {...props} className={`w-full rounded-xl border border-slate-300 px-3 py-3 outline-none focus:border-sky-500 ${className}`} />;
}

function Textarea({ className = "", ...props }) {
  return <textarea {...props} className={`w-full rounded-xl border border-slate-300 px-3 py-3 outline-none focus:border-sky-500 ${className}`} />;
}
